class Menu extends Phaser.Scene {
    ...
    create(){
        ...
        //A=B+C
        this.allTextures = ["playerR","playerB","playerY","playerG","playerP","playerK"];
        this.activeTextures = [];
        ...
        this.startTXT = this.add.text(10, 20, "Choose a ship" , {font:"25px Arial", fill:"yellow"}).setAlpha(1);
